...
# ==========================================
TEST_IMG_PATH = "/home/shlee/datasets/eng_back/printer/train/good/1387(1).jpeg"  # 테스트할 이미지 파일 경로
...
def check_roi():
    ...
    # 확인용 이미지 저장
    save_path = "/home/shlee/Final_code/Canon_Printer/anomaly/CROP/roi_check_result_lcd.jpg"
